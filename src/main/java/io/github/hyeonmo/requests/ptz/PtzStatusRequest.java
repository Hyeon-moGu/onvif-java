...
public class PtzStatusRequest implements PtzBaseRequest {
    ...
    public PtzStatusRequest(String xAddr, String profileToken, String userName, String password, long timeOffsetMs) {
        this.xAddr = xAddr;
    ...
    public String getXml() {
        ...
        return builder.getAuthHeader() + builder.getPtzStatusBody(profileToken) + builder.getAuthEnd();
    }
    ...
    public PtzOperationType getPtzOperationType() {
        return PtzOperationType.STATUS;
    }
}
